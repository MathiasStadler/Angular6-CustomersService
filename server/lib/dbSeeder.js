...
class DBSeeder {
  ...
  seed() {
    ...
    let citiesIds = [5, 9, 44, 5, 36, 17, 16, 9, 36, 14, 14, 6, 9, 24, 44, 36, 25, 19, 5, 14, 5, 23, 38, 17];
    ...
    for (i = 0; i < l; i++) {
      let nameGenderHost = customerNames[i].split(',');
      let cityState = citiesStates[i].split(',');
